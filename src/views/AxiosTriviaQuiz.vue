  ...
  <body>
    <v-row class="vrow">
        <v-col
            ...
            lg="6"
        >
            <v-card ref="form" class="ma-15" max-width="700" max-height="800" style="background:linear-gradient(#facfce, #f86f4d, #eb603d)">
                <v-card-text>
                  <section class="quiz" v-if="!squiz">
                    
                    <center><h1 id="headline">Quiz Application - Cartoon & Animation</h1></center>
                    <img id="logo-crown" src="https://i.ibb.co/HKj6V6C/pngegg-1.png" class="height:10px;width:10px;" alt="Quiz" /> 
